...
import { useNodeContext } from '../contexts/NodeContext.js'
    ...
    const collectDepends = (field: string, nodeIsSource: boolean) => {
      ...
      if (value) {
        if (typeof value === 'string') {
          ...
          throw new Error(`${field} must be a string or string array of string`)
        }
 ...
 */
export default function Dependency(props: Partial<DependencyProps>) {
  if (props._dependsOn || props._dependsBy) {
