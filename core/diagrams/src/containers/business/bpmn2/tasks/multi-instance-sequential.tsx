...
export const MULTI_INSTANCE_SEQUENTIAL = {
  _style: {
    container:
...
export function MultiInstanceSequential(props: NodeProps) {
  return (
    <Shape {...props} _style={extendStyle(props, MULTI_INSTANCE_SEQUENTIAL)} />
  )
}
