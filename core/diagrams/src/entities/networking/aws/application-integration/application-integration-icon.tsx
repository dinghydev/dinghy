...
export const APPLICATION_INTEGRATION_ICON = {
  _style: {
    entity:
...
export function ApplicationIntegrationIcon(props: DiagramNodeProps) {
  return (
    <Shape
      {...APPLICATION_INTEGRATION_ICON}
      {...props}
      _style={extendStyle(APPLICATION_INTEGRATION_ICON, props)}
    />
  )
}
