...
export const LOOKOUT_FOR_EQUIPMENT = {
  _style: {
    entity:
...
export function LookoutForEquipment(props: NodeProps) {
  return <Shape {...props} _style={extendStyle(props, LOOKOUT_FOR_EQUIPMENT)} />
}
