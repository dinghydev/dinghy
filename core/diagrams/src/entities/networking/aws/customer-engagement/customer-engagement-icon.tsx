...
export const CUSTOMER_ENGAGEMENT_ICON = {
  _style: {
    entity:
...
export function CustomerEngagementIcon(props: DiagramNodeProps) {
  return (
    <Shape
      {...CUSTOMER_ENGAGEMENT_ICON}
      {...props}
      _style={extendStyle(CUSTOMER_ENGAGEMENT_ICON, props)}
    />
  )
}
