...
export const MANAGEMENT_GOVERNANCE_ICON = {
  _style: {
    entity:
...
export function ManagementGovernanceIcon(props: DiagramNodeProps) {
  return (
    <Shape
      {...MANAGEMENT_GOVERNANCE_ICON}
      {...props}
      _style={extendStyle(MANAGEMENT_GOVERNANCE_ICON, props)}
    />
  )
}
