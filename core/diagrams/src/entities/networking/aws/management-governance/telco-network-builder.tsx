...
export const TELCO_NETWORK_BUILDER = {
  _style: {
    entity:
...
export function TelcoNetworkBuilder(props: NodeProps) {
  return <Shape {...props} _style={extendStyle(props, TELCO_NETWORK_BUILDER)} />
}
