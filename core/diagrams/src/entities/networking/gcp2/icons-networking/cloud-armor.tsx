...
export function CloudArmor(props: NodeProps) {
  return (
    <Shape
      {...CLOUD_ARMOR}
      {...props}
      _style={extendStyle(CLOUD_ARMOR, props)}
    />
  )
}
