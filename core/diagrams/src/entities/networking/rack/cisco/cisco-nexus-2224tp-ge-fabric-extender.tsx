...
export function CiscoNexus2224tpGeFabricExtender(props: NodeProps) {
  return (
    <Shape
      {...CISCO_NEXUS_2224TP_GE_FABRIC_EXTENDER}
      {...props}
      _style={extendStyle(CISCO_NEXUS_2224TP_GE_FABRIC_EXTENDER, props)}
    />
  )
}
