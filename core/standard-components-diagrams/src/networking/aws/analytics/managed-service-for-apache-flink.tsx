...
export const MANAGED_SERVICE_FOR_APACHE_FLINK = {
  _style:
...
export function ManagedServiceForApacheFlink(props: DiagramNodeProps) {
  return <Shape {...MANAGED_SERVICE_FOR_APACHE_FLINK} {...props} />
}
