...
export const MANAGED_STREAMING_FOR_APACHE_KAFKA = {
  _style:
...
export function ManagedStreamingForApacheKafka(props: DiagramNodeProps) {
  return <Shape {...MANAGED_STREAMING_FOR_APACHE_KAFKA} {...props} />
}
