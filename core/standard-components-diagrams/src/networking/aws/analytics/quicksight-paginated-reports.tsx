...
export const QUICKSIGHT_PAGINATED_REPORTS = {
  _style:
...
export function QuicksightPaginatedReports(props: DiagramNodeProps) {
  return <Shape {...QUICKSIGHT_PAGINATED_REPORTS} {...props} />
}
