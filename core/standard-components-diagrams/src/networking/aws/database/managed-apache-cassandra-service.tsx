...
export const MANAGED_APACHE_CASSANDRA_SERVICE = {
  _style:
...
export function ManagedApacheCassandraService(props: DiagramNodeProps) {
  return <Shape {...MANAGED_APACHE_CASSANDRA_SERVICE} {...props} />
}
