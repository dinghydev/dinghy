...
export const CLOUDWATCH_CROSS_ACCOUNT_OBSERVABILITY = {
  _style:
...
export function CloudwatchCrossAccountObservability(props: DiagramNodeProps) {
  return <Shape {...CLOUDWATCH_CROSS_ACCOUNT_OBSERVABILITY} {...props} />
}
