...
export const SERVICE_MANAGEMENT_CONNECTOR = {
  _style:
...
export function ServiceManagementConnector(props: DiagramNodeProps) {
  return <Shape {...SERVICE_MANAGEMENT_CONNECTOR} {...props} />
}
