...
export const SYSTEMS_MANAGER_INCIDENT_MANAGER = {
  _style:
...
export function SystemsManagerIncidentManager(props: DiagramNodeProps) {
  return <Shape {...SYSTEMS_MANAGER_INCIDENT_MANAGER} {...props} />
}
