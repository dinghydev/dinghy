...
export const INFREQUENT_ACCESS_STORAGE_CLASS = {
  _style:
...
export function InfrequentAccessStorageClass(props: DiagramNodeProps) {
  return <Shape {...INFREQUENT_ACCESS_STORAGE_CLASS} {...props} />
}
