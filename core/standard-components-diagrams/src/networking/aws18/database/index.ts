export { AMAZON_AURORA, AmazonAurora } from './amazon-aurora.tsx'

export { AMAZON_DYNAMODB, AmazonDynamodb } from './amazon-dynamodb.tsx'

export { AMAZON_ELASTICACHE, AmazonElasticache } from './amazon-elasticache.tsx'

export {
  AMAZON_ELASTICACHE_FOR_MEMCACHED,
  AmazonElasticacheForMemcached,
} from './amazon-elasticache-for-memcached.tsx'

export {
  AMAZON_ELASTICACHE_FOR_REDIS,
  AmazonElasticacheForRedis,
} from './amazon-elasticache-for-redis.tsx'

export { AMAZON_NEPTUNE, AmazonNeptune } from './amazon-neptune.tsx'

export { AMAZON_RDS, AmazonRds } from './amazon-rds.tsx'
...
} from './ms-sql-instance-alternate.tsx'
...
} from './mysql-db-instance-alternate.tsx'
