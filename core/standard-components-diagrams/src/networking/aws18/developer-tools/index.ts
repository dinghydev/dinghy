...
export { AWS_CODEBUILD, AwsCodebuild } from './aws-codebuild.tsx'

export { AWS_CODECOMMIT, AwsCodecommit } from './aws-codecommit.tsx'

export { AWS_CODEDEPLOY, AwsCodedeploy } from './aws-codedeploy.tsx'
...
export { AWS_X_RAY, AwsXRay } from './aws-x-ray.tsx'
