...
export { AMAZON_GUARDDUTY, AmazonGuardduty } from './amazon-guardduty.tsx'

export { AMAZON_INSPECTOR, AmazonInspector } from './amazon-inspector.tsx'

export { AWS_ARTIFACT, AwsArtifact } from './aws-artifact.tsx'

export {
  AWS_CERTIFICATE_MANAGER,
  AwsCertificateManager,
} from './aws-certificate-manager.tsx'

export { AWS_CLOUDHSM, AwsCloudhsm } from './aws-cloudhsm.tsx'

export {
  AWS_DIRECTORY_SERVICE,
  AwsDirectoryService,
} from './aws-directory-service.tsx'
...
export {
  AWS_SECRETS_MANAGER,
  AwsSecretsManager,
} from './aws-secrets-manager.tsx'

export { AWS_SHIELD, AwsShield } from './aws-shield.tsx'
