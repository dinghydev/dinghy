export { ANALYSIS_SERVICES, AnalysisServices } from './analysis-services.tsx'
...
export { HDINSIGHT_CLUSTERS, HdinsightClusters } from './hdinsight-clusters.tsx'
...
export { STREAM_ANALYTICS, StreamAnalytics } from './stream-analytics.tsx'
