...
export const SECURE_CATALYST_SWITCH_COLOR_3 = {
  _style:
...
export function SecureCatalystSwitchColor3(props: DiagramNodeProps) {
  return (
    <Shape
      {...SECURE_CATALYST_SWITCH_COLOR_3}
      {...props}
      _style={extendStyle(SECURE_CATALYST_SWITCH_COLOR_3, props)}
    />
  )
}
