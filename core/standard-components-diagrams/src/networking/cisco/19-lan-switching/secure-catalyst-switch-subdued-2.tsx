...
export const SECURE_CATALYST_SWITCH_SUBDUED_2 = {
  _style:
...
export function SecureCatalystSwitchSubdued2(props: DiagramNodeProps) {
  return <Shape {...SECURE_CATALYST_SWITCH_SUBDUED_2} {...props} />
}
