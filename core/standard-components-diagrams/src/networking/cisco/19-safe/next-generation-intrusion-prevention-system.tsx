...
export const NEXT_GENERATION_INTRUSION_PREVENTION_SYSTEM = {
  _style:
...
export function NextGenerationIntrusionPreventionSystem(
  props: DiagramNodeProps,
) {
  return <Shape {...NEXT_GENERATION_INTRUSION_PREVENTION_SYSTEM} {...props} />
}
