...
export const WIRELESS_INTRUSION_PREVENTION = {
  _style:
...
export function WirelessIntrusionPrevention(props: DiagramNodeProps) {
  return (
    <Shape
      {...WIRELESS_INTRUSION_PREVENTION}
      {...props}
      _style={extendStyle(WIRELESS_INTRUSION_PREVENTION, props)}
    />
  )
}
