...
export function CiscoNexus2148tFabricExtender(props: DiagramNodeProps) {
  return (
    <Shape
      {...CISCO_NEXUS_2148T_FABRIC_EXTENDER}
      {...props}
      _style={extendStyle(CISCO_NEXUS_2148T_FABRIC_EXTENDER, props)}
    />
  )
}
