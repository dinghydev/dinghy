...
export const ARUBA_7010_MOBILITY_CONTROLLER_FRONT = {
  _style:
...
export function Aruba7010MobilityControllerFront(props: DiagramNodeProps) {
  return (
    <Shape
      {...ARUBA_7010_MOBILITY_CONTROLLER_FRONT}
      {...props}
      _style={extendStyle(ARUBA_7010_MOBILITY_CONTROLLER_FRONT, props)}
    />
  )
}
