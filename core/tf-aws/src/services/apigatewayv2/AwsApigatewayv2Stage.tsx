...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.0/docs/resources/apigatewayv2_stage
...
export const useAwsApigatewayv2Stage = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsApigatewayv2Stage, node, id)

export const useAwsApigatewayv2Stages = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsApigatewayv2Stage, node, id)
