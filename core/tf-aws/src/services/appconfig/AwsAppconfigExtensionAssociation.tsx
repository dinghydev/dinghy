...
export const useAwsAppconfigExtensionAssociation = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsAppconfigExtensionAssociation, node, id)

export const useAwsAppconfigExtensionAssociations = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsAppconfigExtensionAssociation, node, id)
