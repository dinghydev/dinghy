...
export const DataAwsAppmeshVirtualNodeInputSchema = TfMetaSchema.extend({
...
export const DataAwsAppmeshVirtualNodeOutputSchema = z.object({
...
export type DataAwsAppmeshVirtualNodeInputProps =
  & z.input<typeof DataAwsAppmeshVirtualNodeInputSchema>
  & NodeProps

export type DataAwsAppmeshVirtualNodeOutputProps =
  & z.output<typeof DataAwsAppmeshVirtualNodeOutputSchema>
  & z.output<typeof DataAwsAppmeshVirtualNodeInputSchema>
  & NodeProps

// https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/data-sources/appmesh_virtual_node

export function DataAwsAppmeshVirtualNode(
  props: Partial<DataAwsAppmeshVirtualNodeInputProps>,
) {
  ...
  return (
    <AwsAppmeshVirtualNode
      ...
      _category='data'
      _title={_title}
      _inputSchema={DataAwsAppmeshVirtualNodeInputSchema}
      _outputSchema={DataAwsAppmeshVirtualNodeOutputSchema}
      {...props as any}
    />
  )
}
...
export const useDataAwsAppmeshVirtualNode = (
  ...
  useTypedNode<DataAwsAppmeshVirtualNodeOutputProps>(
...
export const useDataAwsAppmeshVirtualNodes = (
  ...
  useTypedNodes<DataAwsAppmeshVirtualNodeOutputProps>(
    DataAwsAppmeshVirtualNode,
    idFilter,
    baseNode,
    optional,
