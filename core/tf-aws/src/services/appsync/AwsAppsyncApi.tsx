...
export const AwsAppsyncApiInputSchema = TfMetaSchema.extend({
...
export const AwsAppsyncApiOutputSchema = z.object({
...
export type AwsAppsyncApiInputProps =
  & z.input<typeof AwsAppsyncApiInputSchema>
  & NodeProps

export type AwsAppsyncApiOutputProps =
  & z.output<typeof AwsAppsyncApiOutputSchema>
  & z.output<typeof AwsAppsyncApiInputSchema>
  & NodeProps

// https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/appsync_api

export function AwsAppsyncApi(props: Partial<AwsAppsyncApiInputProps>) {
  ...
  return (
    <Shape
      ...
      _category='resource'
      _title={_title}
      _inputSchema={AwsAppsyncApiInputSchema}
      _outputSchema={AwsAppsyncApiOutputSchema}
      {...props}
    />
  )
}
...
export const useAwsAppsyncApi = (
  ...
  useTypedNode<AwsAppsyncApiOutputProps>(
    AwsAppsyncApi,
    idFilter,
    baseNode,
    optional,
...
export const useAwsAppsyncApis = (
  ...
  useTypedNodes<AwsAppsyncApiOutputProps>(
    AwsAppsyncApi,
    idFilter,
    baseNode,
    optional,
