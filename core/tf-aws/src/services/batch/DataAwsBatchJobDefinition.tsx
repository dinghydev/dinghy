...
export const DataAwsBatchJobDefinitionInputSchema = TfMetaSchema.extend({
...
export const DataAwsBatchJobDefinitionOutputSchema = z.object({
...
export type DataAwsBatchJobDefinitionInputProps =
  & z.input<typeof DataAwsBatchJobDefinitionInputSchema>
  & NodeProps

export type DataAwsBatchJobDefinitionOutputProps =
  & z.output<typeof DataAwsBatchJobDefinitionOutputSchema>
  & z.output<typeof DataAwsBatchJobDefinitionInputSchema>
  & NodeProps

// https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/data-sources/batch_job_definition

export function DataAwsBatchJobDefinition(
  props: Partial<DataAwsBatchJobDefinitionInputProps>,
) {
  ...
  return (
    <AwsBatchJobDefinition
      ...
      _category='data'
      _title={_title}
      _inputSchema={DataAwsBatchJobDefinitionInputSchema}
      _outputSchema={DataAwsBatchJobDefinitionOutputSchema}
      {...props as any}
    />
  )
}
...
export const useDataAwsBatchJobDefinition = (
  ...
  useTypedNode<DataAwsBatchJobDefinitionOutputProps>(
...
export const useDataAwsBatchJobDefinitions = (
  ...
  useTypedNodes<DataAwsBatchJobDefinitionOutputProps>(
    DataAwsBatchJobDefinition,
    idFilter,
    baseNode,
    optional,
