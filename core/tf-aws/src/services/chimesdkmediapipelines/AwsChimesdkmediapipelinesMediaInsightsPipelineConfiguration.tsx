...
export const AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationInputSchema =
  TfMetaSchema.extend({
...
export const AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationOutputSchema =
  z.object({
    arn: z.string().optional(),
    id: z.string().optional(),
  })

export const AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationImportSchema =
  z.object({
    arn: resolvableValue(z.string()),
  })

export type AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationInputProps =
  & z.input<
    typeof AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationInputSchema
  >
  & z.input<
    typeof AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationImportSchema
  >
  & NodeProps

export type AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationOutputProps =
  & z.output<
    typeof AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationOutputSchema
  >
  & z.output<
    typeof AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationInputSchema
  >
...
// https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/chimesdkmediapipelines_media_insights_pipeline_configuration
...
export function AwsChimesdkmediapipelinesMediaInsightsPipelineConfiguration(
  ...
  return (
    <Shape
      ...
      _category='resource'
      _title={_title}
      _inputSchema={AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationInputSchema}
      _outputSchema={AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationOutputSchema}
      _importSchema={AwsChimesdkmediapipelinesMediaInsightsPipelineConfigurationImportSchema}
      {...props}
    />
  )
}
