...
export const useAwsCloudformationStackSetInstance = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsCloudformationStackSetInstance, node, id)

export const useAwsCloudformationStackSetInstances = (
  node?: any,
  id?: string,
) => useTypedNodes<OutputProps>(AwsCloudformationStackSetInstance, node, id)
