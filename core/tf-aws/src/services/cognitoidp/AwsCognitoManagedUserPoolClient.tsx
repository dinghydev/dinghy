...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.0/docs/resources/cognito_managed_user_pool_client
...
export const InputSchema = z.object({
  ...
  name_pattern: resolvableValue(z.string().optional()),
...
export const useAwsCognitoManagedUserPoolClient = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsCognitoManagedUserPoolClient, node, id)

export const useAwsCognitoManagedUserPoolClients = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsCognitoManagedUserPoolClient, node, id)
