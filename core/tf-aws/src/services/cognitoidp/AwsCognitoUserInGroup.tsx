...
export const useAwsCognitoUserInGroup = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsCognitoUserInGroup, node, id)

export const useAwsCognitoUserInGroups = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsCognitoUserInGroup, node, id)
