...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.0/docs/resources/config_conformance_pack
...
export const useAwsConfigConformancePack = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsConfigConformancePack, node, id)

export const useAwsConfigConformancePacks = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsConfigConformancePack, node, id)
