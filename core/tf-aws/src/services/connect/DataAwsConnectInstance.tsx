...
// https://registry.terraform.io/providers/hashicorp/aws/6.28.0/docs/data-sources/connect_instance
...
export const useDataAwsConnectInstance = (
  idFilter?: string,
  baseNode?: any,
  optional?: boolean,
) =>
...
export const useDataAwsConnectInstances = (
  idFilter?: string,
  baseNode?: any,
  optional?: boolean,
) =>
