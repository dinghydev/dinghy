...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.0/docs/resources/dx_hosted_private_virtual_interface
...
export function AwsDxHostedPrivateVirtualInterface(props: Partial<InputProps>) {
...
export const useAwsDxHostedPrivateVirtualInterface = (
  node?: any,
  id?: string,
) => useTypedNode<OutputProps>(AwsDxHostedPrivateVirtualInterface, node, id)

export const useAwsDxHostedPrivateVirtualInterfaces = (
  node?: any,
  id?: string,
) => useTypedNodes<OutputProps>(AwsDxHostedPrivateVirtualInterface, node, id)
