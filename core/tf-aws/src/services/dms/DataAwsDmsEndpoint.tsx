...
export const OutputSchema = z.object({
  ...
  extra_connection_attributes: z.string().optional(),
  kafka_settings: z.object({
    broker: z.string(),
  ...
  secrets_manager_access_role_arn: z.string().optional(),
  secrets_manager_arn: z.string().optional(),
  server_name: z.string().optional(),
  service_access_role: z.string().optional(),
