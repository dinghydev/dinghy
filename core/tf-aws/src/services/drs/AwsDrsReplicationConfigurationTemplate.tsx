...
export const AwsDrsReplicationConfigurationTemplateInputSchema = TfMetaSchema
  .extend({
    ...
    replication_servers_security_groups_ids: resolvableValue(
      z.string().array(),
    ),
...
export const AwsDrsReplicationConfigurationTemplateOutputSchema = z.object({
  arn: z.string().optional(),
  id: z.string().optional(),
  tags_all: z.record(z.string(), z.string()).optional(),
})

export type AwsDrsReplicationConfigurationTemplateInputProps =
  & z.input<typeof AwsDrsReplicationConfigurationTemplateInputSchema>
  & NodeProps

export type AwsDrsReplicationConfigurationTemplateOutputProps =
  & z.output<typeof AwsDrsReplicationConfigurationTemplateOutputSchema>
  & z.output<typeof AwsDrsReplicationConfigurationTemplateInputSchema>
  & NodeProps
...
export function AwsDrsReplicationConfigurationTemplate(
  props: Partial<AwsDrsReplicationConfigurationTemplateInputProps>,
) {
  ...
  return (
    <Shape
      ...
      _category='resource'
      _title={_title}
      _inputSchema={AwsDrsReplicationConfigurationTemplateInputSchema}
      _outputSchema={AwsDrsReplicationConfigurationTemplateOutputSchema}
      {...props}
    />
  )
}
...
export const useAwsDrsReplicationConfigurationTemplate = (
  ...
  useTypedNode<AwsDrsReplicationConfigurationTemplateOutputProps>(
...
export const useAwsDrsReplicationConfigurationTemplates = (
  ...
  useTypedNodes<AwsDrsReplicationConfigurationTemplateOutputProps>(
    AwsDrsReplicationConfigurationTemplate,
    idFilter,
    baseNode,
    optional,
