...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.0/docs/data-sources/ebs_volume
...
export const useDataAwsEbsVolume = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(DataAwsEbsVolume, node, id)

export const useDataAwsEbsVolumes = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(DataAwsEbsVolume, node, id)
