...
export const useAwsAmi = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsAmi, node, id)

export const useAwsAmis = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsAmi, node, id)
