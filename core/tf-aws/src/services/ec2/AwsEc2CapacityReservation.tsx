...
export const useAwsEc2CapacityReservation = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsEc2CapacityReservation, node, id)

export const useAwsEc2CapacityReservations = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsEc2CapacityReservation, node, id)
