...
export const useAwsEc2TransitGateway = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsEc2TransitGateway, node, id)

export const useAwsEc2TransitGateways = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsEc2TransitGateway, node, id)
