...
export const DataAwsEc2InstanceTypeInputSchema = TfMetaSchema.extend({
...
export const DataAwsEc2InstanceTypeOutputSchema = z.object({
...
export type DataAwsEc2InstanceTypeInputProps =
  & z.input<typeof DataAwsEc2InstanceTypeInputSchema>
  & NodeProps

export type DataAwsEc2InstanceTypeOutputProps =
  & z.output<typeof DataAwsEc2InstanceTypeOutputSchema>
  & z.output<typeof DataAwsEc2InstanceTypeInputSchema>
  & NodeProps

// https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/data-sources/ec2_instance_type

export function DataAwsEc2InstanceType(
  props: Partial<DataAwsEc2InstanceTypeInputProps>,
) {
  ...
  return (
    <Shape
      ...
      _category='data'
      _title={_title}
      _inputSchema={DataAwsEc2InstanceTypeInputSchema}
      _outputSchema={DataAwsEc2InstanceTypeOutputSchema}
      {...props}
    />
  )
}
...
export const useDataAwsEc2InstanceType = (
  ...
  useTypedNode<DataAwsEc2InstanceTypeOutputProps>(
...
export const useDataAwsEc2InstanceTypes = (
  ...
  useTypedNodes<DataAwsEc2InstanceTypeOutputProps>(
    DataAwsEc2InstanceType,
    idFilter,
    baseNode,
    optional,
