...
export const useAwsEksCluster = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsEksCluster, node, id)

export const useAwsEksClusters = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsEksCluster, node, id)
