...
export const DataAwsEksNodeGroupInputSchema = TfMetaSchema.extend({
  cluster_name: resolvableValue(z.string()),
  node_group_name: resolvableValue(z.string()),
  region: resolvableValue(z.string().optional()),
})

export const DataAwsEksNodeGroupOutputSchema = z.object({
...
export type DataAwsEksNodeGroupInputProps =
  & z.input<typeof DataAwsEksNodeGroupInputSchema>
  & NodeProps

export type DataAwsEksNodeGroupOutputProps =
  & z.output<typeof DataAwsEksNodeGroupOutputSchema>
  & z.output<typeof DataAwsEksNodeGroupInputSchema>
  & NodeProps

// https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/data-sources/eks_node_group

export function DataAwsEksNodeGroup(
  props: Partial<DataAwsEksNodeGroupInputProps>,
) {
  ...
  return (
    <AwsEksNodeGroup
      ...
      _category='data'
      _title={_title}
      _inputSchema={DataAwsEksNodeGroupInputSchema}
      _outputSchema={DataAwsEksNodeGroupOutputSchema}
      {...props as any}
    />
  )
}
...
export const useDataAwsEksNodeGroup = (
  ...
  useTypedNode<DataAwsEksNodeGroupOutputProps>(
    DataAwsEksNodeGroup,
    idFilter,
    baseNode,
    optional,
...
export const useDataAwsEksNodeGroups = (
  ...
  useTypedNodes<DataAwsEksNodeGroupOutputProps>(
    DataAwsEksNodeGroup,
    idFilter,
    baseNode,
    optional,
