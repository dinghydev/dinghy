...
// https://registry.terraform.io/providers/hashicorp/aws/6.22.0/docs/resources/elasticsearch_domain_saml_options
...
export const useAwsElasticsearchDomainSamlOptions = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsElasticsearchDomainSamlOptions, node, id)
