...
export const AwsGlueConnectionInputSchema = TfMetaSchema.extend({
...
export const AwsGlueConnectionOutputSchema = z.object({
  arn: z.string().optional(),
  id: z.string().optional(),
  tags_all: z.record(z.string(), z.string()).optional(),
})

export type AwsGlueConnectionInputProps =
  & z.input<typeof AwsGlueConnectionInputSchema>
  & NodeProps

export type AwsGlueConnectionOutputProps =
  & z.output<typeof AwsGlueConnectionOutputSchema>
  & z.output<typeof AwsGlueConnectionInputSchema>
  & NodeProps

// https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/glue_connection

export function AwsGlueConnection(props: Partial<AwsGlueConnectionInputProps>) {
  ...
  return (
    <Shape
      ...
      _category='resource'
      _title={_title}
      _inputSchema={AwsGlueConnectionInputSchema}
      _outputSchema={AwsGlueConnectionOutputSchema}
      {...props}
    />
  )
}
...
export const useAwsGlueConnection = (
  ...
  useTypedNode<AwsGlueConnectionOutputProps>(
    AwsGlueConnection,
    idFilter,
    baseNode,
    optional,
...
export const useAwsGlueConnections = (
  ...
  useTypedNodes<AwsGlueConnectionOutputProps>(
    AwsGlueConnection,
    idFilter,
    baseNode,
    optional,
