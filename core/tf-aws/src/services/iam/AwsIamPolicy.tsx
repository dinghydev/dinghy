...
export const useAwsIamPolicy = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsIamPolicy, node, id)

export const useAwsIamPolicys = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsIamPolicy, node, id)
