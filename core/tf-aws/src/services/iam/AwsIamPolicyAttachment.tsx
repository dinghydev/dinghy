...
export const useAwsIamPolicyAttachment = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsIamPolicyAttachment, node, id)

export const useAwsIamPolicyAttachments = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsIamPolicyAttachment, node, id)
