...
export const AwsImagebuilderDistributionConfigurationInputSchema = TfMetaSchema
  .extend({
...
export const AwsImagebuilderDistributionConfigurationOutputSchema = z.object({
...
export const AwsImagebuilderDistributionConfigurationImportSchema = z.object({
  arn: resolvableValue(z.string()),
})

export type AwsImagebuilderDistributionConfigurationInputProps =
  & z.input<typeof AwsImagebuilderDistributionConfigurationInputSchema>
  & z.input<typeof AwsImagebuilderDistributionConfigurationImportSchema>
  & NodeProps

export type AwsImagebuilderDistributionConfigurationOutputProps =
  & z.output<typeof AwsImagebuilderDistributionConfigurationOutputSchema>
  & z.output<typeof AwsImagebuilderDistributionConfigurationInputSchema>
  & NodeProps
...
export function AwsImagebuilderDistributionConfiguration(
  props: Partial<AwsImagebuilderDistributionConfigurationInputProps>,
) {
  ...
  return (
    <Shape
      ...
      _category='resource'
      _title={_title}
      _inputSchema={AwsImagebuilderDistributionConfigurationInputSchema}
      _outputSchema={AwsImagebuilderDistributionConfigurationOutputSchema}
      _importSchema={AwsImagebuilderDistributionConfigurationImportSchema}
      {...props}
    />
  )
}
...
export const useAwsImagebuilderDistributionConfiguration = (
  ...
  useTypedNode<AwsImagebuilderDistributionConfigurationOutputProps>(
...
export const useAwsImagebuilderDistributionConfigurations = (
  ...
  useTypedNodes<AwsImagebuilderDistributionConfigurationOutputProps>(
    AwsImagebuilderDistributionConfiguration,
    idFilter,
    baseNode,
    optional,
