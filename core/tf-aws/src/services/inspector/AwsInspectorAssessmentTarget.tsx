...
export const useAwsInspectorAssessmentTarget = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsInspectorAssessmentTarget, node, id)

export const useAwsInspectorAssessmentTargets = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsInspectorAssessmentTarget, node, id)
