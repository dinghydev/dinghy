...
export const useAwsLicensemanagerAssociation = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsLicensemanagerAssociation, node, id)

export const useAwsLicensemanagerAssociations = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsLicensemanagerAssociation, node, id)
