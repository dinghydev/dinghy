...
export const useAwsLightsailLb = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsLightsailLb, node, id)

export const useAwsLightsailLbs = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsLightsailLb, node, id)
