...
export const useAwsMqBroker = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsMqBroker, node, id)

export const useAwsMqBrokers = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsMqBroker, node, id)
