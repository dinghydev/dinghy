...
export const DataAwsNetworkfirewallFirewallInputSchema = TfMetaSchema.extend({
  arn: resolvableValue(z.string().optional()),
  name: resolvableValue(z.string().optional()),
  region: resolvableValue(z.string().optional()),
})

export const DataAwsNetworkfirewallFirewallOutputSchema = z.object({
...
export type DataAwsNetworkfirewallFirewallInputProps =
  & z.input<typeof DataAwsNetworkfirewallFirewallInputSchema>
  & NodeProps

export type DataAwsNetworkfirewallFirewallOutputProps =
  & z.output<typeof DataAwsNetworkfirewallFirewallOutputSchema>
  & z.output<typeof DataAwsNetworkfirewallFirewallInputSchema>
  & NodeProps

// https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/data-sources/networkfirewall_firewall

export function DataAwsNetworkfirewallFirewall(
  props: Partial<DataAwsNetworkfirewallFirewallInputProps>,
) {
  ...
  return (
    <AwsNetworkfirewallFirewall
      ...
      _category='data'
      _title={_title}
      _inputSchema={DataAwsNetworkfirewallFirewallInputSchema}
      _outputSchema={DataAwsNetworkfirewallFirewallOutputSchema}
      {...props as any}
    />
  )
}
...
export const useDataAwsNetworkfirewallFirewall = (
  ...
  useTypedNode<DataAwsNetworkfirewallFirewallOutputProps>(
...
export const useDataAwsNetworkfirewallFirewalls = (
  ...
  useTypedNodes<DataAwsNetworkfirewallFirewallOutputProps>(
    DataAwsNetworkfirewallFirewall,
    idFilter,
    baseNode,
    optional,
