...
export const DataAwsOdbCloudExadataInfrastructureInputSchema = TfMetaSchema
  .extend({
    id: resolvableValue(z.string()),
    region: resolvableValue(z.string().optional()),
  })

export const DataAwsOdbCloudExadataInfrastructureOutputSchema = z.object({
...
export type DataAwsOdbCloudExadataInfrastructureInputProps =
  & z.input<typeof DataAwsOdbCloudExadataInfrastructureInputSchema>
  & NodeProps

export type DataAwsOdbCloudExadataInfrastructureOutputProps =
  & z.output<typeof DataAwsOdbCloudExadataInfrastructureOutputSchema>
  & z.output<typeof DataAwsOdbCloudExadataInfrastructureInputSchema>
  & NodeProps
...
export function DataAwsOdbCloudExadataInfrastructure(
  props: Partial<DataAwsOdbCloudExadataInfrastructureInputProps>,
) {
  ...
  return (
    <AwsOdbCloudExadataInfrastructure
      ...
      _category='data'
      _title={_title}
      _inputSchema={DataAwsOdbCloudExadataInfrastructureInputSchema}
      _outputSchema={DataAwsOdbCloudExadataInfrastructureOutputSchema}
      {...props as any}
    />
  )
}
...
export const useDataAwsOdbCloudExadataInfrastructure = (
  ...
  useTypedNode<DataAwsOdbCloudExadataInfrastructureOutputProps>(
...
export const useDataAwsOdbCloudExadataInfrastructures = (
  ...
  useTypedNodes<DataAwsOdbCloudExadataInfrastructureOutputProps>(
    DataAwsOdbCloudExadataInfrastructure,
    idFilter,
    baseNode,
    optional,
