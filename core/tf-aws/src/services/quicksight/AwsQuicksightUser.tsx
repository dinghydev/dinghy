...
export const useAwsQuicksightUser = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsQuicksightUser, node, id)

export const useAwsQuicksightUsers = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsQuicksightUser, node, id)
