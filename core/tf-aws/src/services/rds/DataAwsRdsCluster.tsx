...
export const DataAwsRdsClusterInputSchema = TfMetaSchema.extend({
  cluster_identifier: resolvableValue(z.string()),
  id: resolvableValue(z.string().optional()),
  region: resolvableValue(z.string().optional()),
})

export const DataAwsRdsClusterOutputSchema = z.object({
...
export type DataAwsRdsClusterInputProps =
  & z.input<typeof DataAwsRdsClusterInputSchema>
  & NodeProps

export type DataAwsRdsClusterOutputProps =
  & z.output<typeof DataAwsRdsClusterOutputSchema>
  & z.output<typeof DataAwsRdsClusterInputSchema>
  & NodeProps

// https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/data-sources/rds_cluster

export function DataAwsRdsCluster(props: Partial<DataAwsRdsClusterInputProps>) {
  ...
  return (
    <AwsRdsCluster
      ...
      _category='data'
      _title={_title}
      _inputSchema={DataAwsRdsClusterInputSchema}
      _outputSchema={DataAwsRdsClusterOutputSchema}
      {...props as any}
    />
  )
}
...
export const useDataAwsRdsCluster = (
  ...
  useTypedNode<DataAwsRdsClusterOutputProps>(
    DataAwsRdsCluster,
    idFilter,
    baseNode,
    optional,
...
export const useDataAwsRdsClusters = (
  ...
  useTypedNodes<DataAwsRdsClusterOutputProps>(
    DataAwsRdsCluster,
    idFilter,
    baseNode,
    optional,
