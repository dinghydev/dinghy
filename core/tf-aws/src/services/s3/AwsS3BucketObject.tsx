...
export const useAwsS3BucketObject = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsS3BucketObject, node, id)

export const useAwsS3BucketObjects = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsS3BucketObject, node, id)
