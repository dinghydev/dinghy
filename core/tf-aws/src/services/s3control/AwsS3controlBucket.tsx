...
export const useAwsS3controlBucket = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsS3controlBucket, node, id)

export const useAwsS3controlBuckets = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsS3controlBucket, node, id)
