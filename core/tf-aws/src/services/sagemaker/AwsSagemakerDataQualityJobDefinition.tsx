...
export const AwsSagemakerDataQualityJobDefinitionInputSchema = TfMetaSchema
  .extend({
...
export const AwsSagemakerDataQualityJobDefinitionOutputSchema = z.object({
  arn: z.string().optional(),
  name: z.string().optional(),
  tags_all: z.record(z.string(), z.string()).optional(),
})

export type AwsSagemakerDataQualityJobDefinitionInputProps =
  & z.input<typeof AwsSagemakerDataQualityJobDefinitionInputSchema>
  & NodeProps

export type AwsSagemakerDataQualityJobDefinitionOutputProps =
  & z.output<typeof AwsSagemakerDataQualityJobDefinitionOutputSchema>
  & z.output<typeof AwsSagemakerDataQualityJobDefinitionInputSchema>
  & NodeProps

// https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/sagemaker_data_quality_job_definition

export function AwsSagemakerDataQualityJobDefinition(
  props: Partial<AwsSagemakerDataQualityJobDefinitionInputProps>,
) {
  ...
  return (
    <Shape
      ...
      _category='resource'
      _title={_title}
      _inputSchema={AwsSagemakerDataQualityJobDefinitionInputSchema}
      _outputSchema={AwsSagemakerDataQualityJobDefinitionOutputSchema}
      {...props}
    />
  )
}
...
export const useAwsSagemakerDataQualityJobDefinition = (
  ...
  useTypedNode<AwsSagemakerDataQualityJobDefinitionOutputProps>(
...
export const useAwsSagemakerDataQualityJobDefinitions = (
  ...
  useTypedNodes<AwsSagemakerDataQualityJobDefinitionOutputProps>(
    AwsSagemakerDataQualityJobDefinition,
    idFilter,
    baseNode,
    optional,
