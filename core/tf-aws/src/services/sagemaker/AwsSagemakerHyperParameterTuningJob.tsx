...
export const AwsSagemakerHyperParameterTuningJobInputSchema = TfMetaSchema
  .extend({
...
export const AwsSagemakerHyperParameterTuningJobOutputSchema = z.object({
...
export const AwsSagemakerHyperParameterTuningJobImportSchema = z.object({
  name: resolvableValue(z.string()),
  account_id: resolvableValue(z.string().optional()),
  region: resolvableValue(z.string().optional()),
})

export type AwsSagemakerHyperParameterTuningJobInputProps =
  & z.input<typeof AwsSagemakerHyperParameterTuningJobInputSchema>
  & z.input<typeof AwsSagemakerHyperParameterTuningJobImportSchema>
  & NodeProps

export type AwsSagemakerHyperParameterTuningJobOutputProps =
  & z.output<typeof AwsSagemakerHyperParameterTuningJobOutputSchema>
  & z.output<typeof AwsSagemakerHyperParameterTuningJobInputSchema>
  & NodeProps
...
export function AwsSagemakerHyperParameterTuningJob(
  props: Partial<AwsSagemakerHyperParameterTuningJobInputProps>,
) {
  ...
  return (
    <Shape
      ...
      _category='resource'
      _title={_title}
      _inputSchema={AwsSagemakerHyperParameterTuningJobInputSchema}
      _outputSchema={AwsSagemakerHyperParameterTuningJobOutputSchema}
      _importSchema={AwsSagemakerHyperParameterTuningJobImportSchema}
      {...props}
    />
  )
}
...
export const useAwsSagemakerHyperParameterTuningJob = (
  ...
  useTypedNode<AwsSagemakerHyperParameterTuningJobOutputProps>(
...
export const useAwsSagemakerHyperParameterTuningJobs = (
  ...
  useTypedNodes<AwsSagemakerHyperParameterTuningJobOutputProps>(
    AwsSagemakerHyperParameterTuningJob,
    idFilter,
    baseNode,
    optional,
