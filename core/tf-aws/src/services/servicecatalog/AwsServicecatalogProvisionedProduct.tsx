...
export const AwsServicecatalogProvisionedProductInputSchema = TfMetaSchema
  .extend({
...
export const AwsServicecatalogProvisionedProductOutputSchema = z.object({
...
export type AwsServicecatalogProvisionedProductInputProps =
  & z.input<typeof AwsServicecatalogProvisionedProductInputSchema>
  & NodeProps

export type AwsServicecatalogProvisionedProductOutputProps =
  & z.output<typeof AwsServicecatalogProvisionedProductOutputSchema>
  & z.output<typeof AwsServicecatalogProvisionedProductInputSchema>
  & NodeProps
...
export function AwsServicecatalogProvisionedProduct(
  props: Partial<AwsServicecatalogProvisionedProductInputProps>,
) {
  ...
  return (
    <Shape
      ...
      _category='resource'
      _title={_title}
      _inputSchema={AwsServicecatalogProvisionedProductInputSchema}
      _outputSchema={AwsServicecatalogProvisionedProductOutputSchema}
      {...props}
    />
  )
}
...
export const useAwsServicecatalogProvisionedProduct = (
  ...
  useTypedNode<AwsServicecatalogProvisionedProductOutputProps>(
...
export const useAwsServicecatalogProvisionedProducts = (
  ...
  useTypedNodes<AwsServicecatalogProvisionedProductOutputProps>(
    AwsServicecatalogProvisionedProduct,
    idFilter,
    baseNode,
    optional,
