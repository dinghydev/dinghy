...
export const useAwsSqsQueue = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsSqsQueue, node, id)

export const useAwsSqsQueues = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsSqsQueue, node, id)
