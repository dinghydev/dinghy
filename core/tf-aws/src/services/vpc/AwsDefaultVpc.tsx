...
export const useAwsDefaultVpc = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsDefaultVpc, node, id)

export const useAwsDefaultVpcs = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsDefaultVpc, node, id)
