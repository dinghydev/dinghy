...
export const useAwsNatGateway = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsNatGateway, node, id)

export const useAwsNatGateways = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsNatGateway, node, id)
