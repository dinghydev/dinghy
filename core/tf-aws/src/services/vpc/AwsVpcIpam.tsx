...
export const useAwsVpcIpam = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(AwsVpcIpam, node, id)

export const useAwsVpcIpams = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(AwsVpcIpam, node, id)
