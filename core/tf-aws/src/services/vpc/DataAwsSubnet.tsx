...
export const useDataAwsSubnet = (node?: any, id?: string) =>
  useTypedNode<OutputProps>(DataAwsSubnet, node, id)

export const useDataAwsSubnets = (node?: any, id?: string) =>
  useTypedNodes<OutputProps>(DataAwsSubnet, node, id)
