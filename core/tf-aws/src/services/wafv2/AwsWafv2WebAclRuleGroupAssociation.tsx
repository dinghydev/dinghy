...
export const AwsWafv2WebAclRuleGroupAssociationInputSchema = TfMetaSchema
  .extend({
...
export const AwsWafv2WebAclRuleGroupAssociationOutputSchema = z.object({})

export type AwsWafv2WebAclRuleGroupAssociationInputProps =
  & z.input<typeof AwsWafv2WebAclRuleGroupAssociationInputSchema>
  & NodeProps

export type AwsWafv2WebAclRuleGroupAssociationOutputProps =
  & z.output<typeof AwsWafv2WebAclRuleGroupAssociationOutputSchema>
  & z.output<typeof AwsWafv2WebAclRuleGroupAssociationInputSchema>
  & NodeProps

// https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/wafv2_web_acl_rule_group_association

export function AwsWafv2WebAclRuleGroupAssociation(
  props: Partial<AwsWafv2WebAclRuleGroupAssociationInputProps>,
) {
  ...
  return (
    <Shape
      ...
      _category='resource'
      _title={_title}
      _inputSchema={AwsWafv2WebAclRuleGroupAssociationInputSchema}
      _outputSchema={AwsWafv2WebAclRuleGroupAssociationOutputSchema}
      {...props}
    />
  )
}
...
export const useAwsWafv2WebAclRuleGroupAssociation = (
  ...
  useTypedNode<AwsWafv2WebAclRuleGroupAssociationOutputProps>(
...
export const useAwsWafv2WebAclRuleGroupAssociations = (
  ...
  useTypedNodes<AwsWafv2WebAclRuleGroupAssociationOutputProps>(
    AwsWafv2WebAclRuleGroupAssociation,
    idFilter,
    baseNode,
    optional,
