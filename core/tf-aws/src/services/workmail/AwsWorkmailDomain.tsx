...
export function AwsWorkmailDomain(props: Partial<InputProps>) {
...
export const useAwsWorkmailDomain = (
  ...
  baseNode?: any,
  optional?: boolean,
) => useTypedNode<OutputProps>(AwsWorkmailDomain, idFilter, baseNode, optional)

export const useAwsWorkmailDomains = (
  idFilter?: string,
  baseNode?: any,
  optional?: boolean,
) => useTypedNodes<OutputProps>(AwsWorkmailDomain, idFilter, baseNode, optional)
