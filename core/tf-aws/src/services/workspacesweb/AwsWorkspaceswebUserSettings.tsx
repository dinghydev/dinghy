...
export const AwsWorkspaceswebUserSettingsInputSchema = TfMetaSchema.extend({
...
export const AwsWorkspaceswebUserSettingsOutputSchema = z.object({
  associated_portal_arns: z.string().array().optional(),
  tags_all: z.record(z.string(), z.string()).optional(),
  user_settings_arn: z.string().optional(),
})

export type AwsWorkspaceswebUserSettingsInputProps =
  & z.input<typeof AwsWorkspaceswebUserSettingsInputSchema>
  & NodeProps

export type AwsWorkspaceswebUserSettingsOutputProps =
  & z.output<typeof AwsWorkspaceswebUserSettingsOutputSchema>
  & z.output<typeof AwsWorkspaceswebUserSettingsInputSchema>
  & NodeProps

// https://registry.terraform.io/providers/hashicorp/aws/6.44.0/docs/resources/workspacesweb_user_settings

export function AwsWorkspaceswebUserSettings(
  props: Partial<AwsWorkspaceswebUserSettingsInputProps>,
) {
  ...
  return (
    <Shape
      ...
      _category='resource'
      _title={_title}
      _inputSchema={AwsWorkspaceswebUserSettingsInputSchema}
      _outputSchema={AwsWorkspaceswebUserSettingsOutputSchema}
      {...props}
    />
  )
}
...
export const useAwsWorkspaceswebUserSettingss = (
  ...
  useTypedNodes<AwsWorkspaceswebUserSettingsOutputProps>(
