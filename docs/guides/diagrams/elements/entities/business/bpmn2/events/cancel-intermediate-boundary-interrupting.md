...
```
import { CancelIntermediateBoundaryInterrupting } from '@dinghy/standard-components-diagrams/bpmn2Events'
...
<img src="./cancel-intermediate-boundary-interrupting.png" width="200"/>
