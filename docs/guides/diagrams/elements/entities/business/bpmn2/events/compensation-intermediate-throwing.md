...
```
import { CompensationIntermediateThrowing } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./compensation-intermediate-throwing.png" width="200"/>
