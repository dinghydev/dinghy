...
```
import { ConditionalIntermediateBoundaryInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./conditional-intermediate-boundary-interrupting.png" width="200"/>
