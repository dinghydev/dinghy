...
```
import { ConditionalIntermediateBoundaryNonInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./conditional-intermediate-boundary-non-interrupting.png" width="200"/>
