...
```
import { ErrorIntermediateBoundaryInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./error-intermediate-boundary-interrupting.png" width="200"/>
