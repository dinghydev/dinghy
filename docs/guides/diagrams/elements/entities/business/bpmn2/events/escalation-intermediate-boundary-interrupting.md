...
```
import { EscalationIntermediateBoundaryInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./escalation-intermediate-boundary-interrupting.png" width="200"/>
