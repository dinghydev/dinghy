...
```
import { EscalationIntermediateBoundaryThrowing } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./escalation-intermediate-boundary-throwing.png" width="200"/>
