...
```
import { EscalationIntermediateNonInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./escalation-intermediate-non-interrupting.png" width="200"/>
