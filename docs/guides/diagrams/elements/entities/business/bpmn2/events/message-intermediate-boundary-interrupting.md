...
```
import { MessageIntermediateBoundaryInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./message-intermediate-boundary-interrupting.png" width="200"/>
