...
```
import { MessageIntermediateBoundaryNonInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./message-intermediate-boundary-non-interrupting.png" width="200"/>
