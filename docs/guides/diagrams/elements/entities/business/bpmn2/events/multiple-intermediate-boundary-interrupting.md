...
```
import { MultipleIntermediateBoundaryInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./multiple-intermediate-boundary-interrupting.png" width="200"/>
