...
```
import { ParallelMultipleIntermediateBoundaryInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./parallel-multiple-intermediate-boundary-interrupting.png" width="200"/>
