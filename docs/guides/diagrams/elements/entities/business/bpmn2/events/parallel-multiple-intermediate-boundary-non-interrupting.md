...
```
import { ParallelMultipleIntermediateBoundaryNonInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./parallel-multiple-intermediate-boundary-non-interrupting.png" width="200"/>
