...
```
import { ParallelMultipleStartNonInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./parallel-multiple-start-non-interrupting.png" width="200"/>
