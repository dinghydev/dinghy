...
```
import { SignalIntermediateBoundaryInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./signal-intermediate-boundary-interrupting.png" width="200"/>
