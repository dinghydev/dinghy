...
```
import { SignalIntermediateBoundaryNonInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./signal-intermediate-boundary-non-interrupting.png" width="200"/>
