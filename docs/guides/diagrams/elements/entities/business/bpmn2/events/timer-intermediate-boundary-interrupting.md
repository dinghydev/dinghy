...
```
import { TimerIntermediateBoundaryInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./timer-intermediate-boundary-interrupting.png" width="200"/>
