...
```
import { TimerIntermediateBoundaryNonInterrupting } from '@reactiac/standard-components-diagrams/bpmn2Events'
...
<img src="./timer-intermediate-boundary-non-interrupting.png" width="200"/>
