...
```
{
  _style: 'points=[];aspect=fixed;html=1;align=center;shadow=0;dashed=0;fillColor=#FF6A00;strokeColor=none;shape=mxgraph.alibaba_cloud.ess_elastic_scaling_service;',
  _width: 55.2,
  _height: 30.3,
}
```
