...
```
import { SimpleNotificationService } from '@reactiac/standard-components-diagrams/awsApplicationIntegration'
...
<img src="./simple-notification-service.png" width="200"/>
