...
```
import { ManagedServiceForPrometheus } from '@reactiac/standard-components-diagrams/awsManagementGovernance'
...
<img src="./managed-service-for-prometheus.png" width="200"/>
