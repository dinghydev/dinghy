...
```
import { ServiceManagementConnector } from '@reactiac/standard-components-diagrams/awsManagementGovernance'
...
<img src="./service-management-connector.png" width="200"/>
