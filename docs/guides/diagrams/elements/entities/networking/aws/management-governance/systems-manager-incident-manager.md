...
```
import { SystemsManagerIncidentManager } from '@reactiac/standard-components-diagrams/awsManagementGovernance'
...
<img src="./systems-manager-incident-manager.png" width="200"/>
