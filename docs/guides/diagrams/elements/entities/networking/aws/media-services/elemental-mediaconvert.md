...
```
import { ElementalMedinghyonvert } from '@dinghy/standard-components-diagrams/awsMediaServices'

<ElementalMedinghyonvert/>
```

## Preview

<img src="./elemental-medinghyonvert.png" width="200"/>
