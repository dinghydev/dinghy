...
```
import { ApplicationMigrationService } from '@reactiac/standard-components-diagrams/awsMigrationModernization'
...
<img src="./application-migration-service.png" width="200"/>
