...
```
{
  ...
  _original_width: 114.99999999999999,
  _original_height: 50,
}
```
...
```
import { ImmersiveTelepresenceEndpoint } from '@dinghy/standard-components-diagrams/cisco19Collaboration'
...
<img src="./immersive-telepresence-endpoint.png" width="200"/>
