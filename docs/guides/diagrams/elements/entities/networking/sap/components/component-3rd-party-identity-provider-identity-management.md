...
```
import { Component3rdPartyIdentityProviderIdentityManagement } from '@reactiac/standard-components-diagrams/sapComponents'
...
<img src="./component-3rd-party-identity-provider-identity-management.png" width="200"/>
