...
```
import { PhotoconductiveTransducerSymmetrical } from '@reactiac/standard-components-diagrams/electricalResistors'
...
<img src="./photoconductive-transducer-symmetrical.png" width="200"/>
