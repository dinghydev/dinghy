...
```
import { BoldToggleWithTooltip3 } from '@reactiac/standard-components-diagrams/atlassian'
...
<img src="./bold-toggle-with-tooltip-3.png" width="200"/>
