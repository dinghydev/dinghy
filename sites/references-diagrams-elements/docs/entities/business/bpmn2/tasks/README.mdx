...
![](./event-sub-process-expanded.png#drawio)

  </TabItem>
  <TabItem value="Usage">
    
```js
import { EventSubProcessExpanded } from '@dinghy/diagrams/entitiesBpmn2Tasks'
...
import { EVENT_SUB_PROCESS_EXPANDED } from '@dinghy/diagrams/entitiesBpmn2Tasks'

<Shape 
  {...props}
  _style={extendStyle(props, EVENT_SUB_PROCESS_EXPANDED)}
  />
