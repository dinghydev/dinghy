...
# Gcp Icons Internet of Things Entities
...
```js
import { IotCore } from '@dinghy/diagrams/entitiesGcpIconsInternetOfThings'
...
import { IOT_CORE } from '@dinghy/diagrams/entitiesGcpIconsInternetOfThings'
