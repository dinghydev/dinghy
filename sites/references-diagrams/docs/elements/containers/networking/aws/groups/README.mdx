...
import { AUTO_SCALING_GROUP } from '@dinghy/diagrams/containersAwsGroups'
...
import { extendStyle } from "@dinghy/base-components";
import { AVAILABILITY_ZONE } from '@dinghy/diagrams/containersAwsGroups'
...
<Shape 
  {...props}
  _style={extendStyle(props, AWS_ACCOUNT)}
  />
...
import { extendStyle } from "@dinghy/base-components";
import { AWS_CLOUD_2 } from '@dinghy/diagrams/containersAwsGroups'

<Shape 
  {...props}
  _style={extendStyle(props, AWS_CLOUD_2)}
  />
...
import { extendStyle } from "@dinghy/base-components";
import { AWS_IOT_GREENGRASS } from '@dinghy/diagrams/containersAwsGroups'

<Shape 
  {...props}
  _style={extendStyle(props, AWS_IOT_GREENGRASS)}
  />
...
import { extendStyle } from "@dinghy/base-components";
import { AWS_STEP_FUNCTIONS_WORKFLOW } from '@dinghy/diagrams/containersAwsGroups'
...
import { extendStyle } from "@dinghy/base-components";
import { CORPORATE_DATA_CENTER } from '@dinghy/diagrams/containersAwsGroups'
...
<Shape 
  {...props}
  _style={extendStyle(props, EC2_INSTANCE_CONTENTS)}
  />
...
import { extendStyle } from "@dinghy/base-components";
import { ELASTIC_BEANSTALK_CONTAINER } from '@dinghy/diagrams/containersAwsGroups'
...
import { extendStyle } from "@dinghy/base-components";
import { GENERIC_GROUP } from '@dinghy/diagrams/containersAwsGroups'
...
import { extendStyle } from "@dinghy/base-components";
import { GENERIC_GROUP_2 } from '@dinghy/diagrams/containersAwsGroups'

<Shape 
  {...props}
  _style={extendStyle(props, GENERIC_GROUP_2)}
  />
...
import { extendStyle } from "@dinghy/base-components";
import { PRIVATE_SUBNET } from '@dinghy/diagrams/containersAwsGroups'
...
import { extendStyle } from "@dinghy/base-components";
import { PUBLIC_SUBNET } from '@dinghy/diagrams/containersAwsGroups'
...
import { extendStyle } from "@dinghy/base-components";
import { SECURITY_GROUP } from '@dinghy/diagrams/containersAwsGroups'
...
import { extendStyle } from "@dinghy/base-components";
import { SERVER_CONTENTS } from '@dinghy/diagrams/containersAwsGroups'

<Shape 
  {...props}
  _style={extendStyle(props, SERVER_CONTENTS)}
  />
...
import { extendStyle } from "@dinghy/base-components";
import { SPOT_FLEET } from '@dinghy/diagrams/containersAwsGroups'
