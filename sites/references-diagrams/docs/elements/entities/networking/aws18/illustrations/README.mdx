...
```js
import { Desktop } from '@dinghy/diagrams/entitiesAws18Illustrations'
...
```js
import { Devices } from '@dinghy/diagrams/entitiesAws18Illustrations'
...
```js
import { Notification } from '@dinghy/diagrams/entitiesAws18Illustrations'
...
```js
import { OfficeBuilding } from '@dinghy/diagrams/entitiesAws18Illustrations'
...
import { extendStyle } from "@dinghy/base-components";
import { OFFICE_BUILDING } from '@dinghy/diagrams/entitiesAws18Illustrations'
...
```js
import { Users } from '@dinghy/diagrams/entitiesAws18Illustrations'
