...
import { extendStyle } from "@dinghy/base-components";
import { CLOUD_COMPOSER } from '@dinghy/diagrams/entitiesGcpIconsDataAnalytics'

<Shape 
  {...props}
  _style={extendStyle(props, CLOUD_COMPOSER)}
  />
...
import { extendStyle } from "@dinghy/base-components";
import { CLOUD_DATA_FUSION } from '@dinghy/diagrams/entitiesGcpIconsDataAnalytics'

<Shape 
  {...props}
  _style={extendStyle(props, CLOUD_DATA_FUSION)}
  />
...
import { extendStyle } from "@dinghy/base-components";
import { DATA_CATALOG } from '@dinghy/diagrams/entitiesGcpIconsDataAnalytics'
...
import { extendStyle } from "@dinghy/base-components";
import { DATA_LAB } from '@dinghy/diagrams/entitiesGcpIconsDataAnalytics'

<Shape 
  {...props}
  _style={extendStyle(props, DATA_LAB)}
  />
...
import { extendStyle } from "@dinghy/base-components";
import { DATA_STUDIO } from '@dinghy/diagrams/entitiesGcpIconsDataAnalytics'

<Shape 
  {...props}
  _style={extendStyle(props, DATA_STUDIO)}
  />
...
<Shape 
  {...props}
  _style={extendStyle(props, DATAFLOW)}
  />
...
<Shape 
  {...props}
  _style={extendStyle(props, DATAPREP)}
  />
...
<Shape 
  {...props}
  _style={extendStyle(props, DATAPROC)}
  />
...
import { extendStyle } from "@dinghy/base-components";
import { PUB_SUB } from '@dinghy/diagrams/entitiesGcpIconsDataAnalytics'

<Shape 
  {...props}
  _style={extendStyle(props, PUB_SUB)}
  />
