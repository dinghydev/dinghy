...
You may found out the list of such composites in [core/standard-components-diagrams/src/composites](https://github.com/dinghydev/dinghy/tree/main/core/standard-components-diagrams/src/composites).
