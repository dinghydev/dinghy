...
[release-base Dockerfile.ejs](https://github.com/dinghydev/dinghy/blob/main/docker/images/61-engine-base/Dockerfile.ejs)
...
[release-dependencies Dockerfile.ejs](https://github.com/dinghydev/dinghy/blob/main/docker/images/65-engine-dependencies/Dockerfile.ejs)
...
If you want to use a different tf version than the [default](https://github.com/dinghydev/dinghy/blob/main/docker/images/50-tf/versions.json), you can specify it in your configuration.
