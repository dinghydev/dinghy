...
[Installation > Prerequisites](./installation.mdx#prerequisites) section for
resolution.
...
<CodeBlock language="tsx" title="my-simple-diagram.tsx">
  {AppTsx}
</CodeBlock>
...
[Step by Step](/examples/step-by-step) examples shows how the code could
...
It will generate a few files in `output` folder include the image `my-simple-diagram.png`:
