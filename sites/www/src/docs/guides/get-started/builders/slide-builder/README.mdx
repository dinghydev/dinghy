...
The `Slide Builder` lets you author [RevealJS](https://revealjs.com/)
presentations in YAML, Markdown, or HTML — and output self-contained HTML files
where all assets (images, styles, scripts) are embedded, ready to share or
deploy.

See [example slide decks](/slides) built with Dinghy.
